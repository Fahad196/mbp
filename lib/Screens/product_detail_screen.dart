        ...
        builder: (BuildContext context) {
          return BlocBuilder<FoodCategoryBloc, FoodCategoryState>(
            ...
            return BlocBuilder<CartBloc, CartState>(
              ...
              if (cartState is AddToCartState) {
                if (state is FoodCategoryLoadedstate) {
                  widget.products = state.hotSellingList[widget.index!];
                  return AlertDialog(
                    content: Container(
                      height:
                          ScreenSizes.isMeduimScreen(context) ? 230.sp : 270.sp,
                      width:
                          ScreenSizes.isMeduimScreen(context) ? 250.sp : 280.sp,
                      child: Column(
                        children: [
                          Row(
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text(itemQuantity.bitLength.toString(),
                                        style: TextStyle(
                                            fontFamily: 'met',
                                            fontSize:
                                                ScreenSizes.isMeduimScreen(
                          ...
                          ElevatedButton(
                            onPressed: () {
                              BlocProvider.of<CartBloc>(context).add(
                                  //AddToCartEvent(products![index!].id!, products![index!].fullPrice! , 1, products![index!].categoryId! , products![index!].resturantId! )
                                  AddToCartEvent(1, 3, 3, 8, 1));
                            },
