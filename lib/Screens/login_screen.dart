...
class _LoginScreenState extends State<LoginScreen> {
  ...
  // void getValue() async {
  //   nameController.text = await getValues("UserId");
  //   passwordController.text = await getValues("Password");
  // }
  ...
  // saveDetails() {
  //   save("UserId", nameController.text);
        ...
        listener: (BuildContext context, state) {
          if (state is LoginSuccess) {
            Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => ResturantScreen(token: state.token,),
                ));
                print("tokennnnnnnnnnnnnnn: ${state.token}");
          }
        },
        child: Stack(
          children: [
