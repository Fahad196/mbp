...
class OrderSummaryRepository {
  ...
  static const endPoint = "https://laravel.artclients.in/api/auth/ordersummary";
  Future<List<OrderSummaryModel>> getOrderSummary(String token) async {
    ...
    try {
      ...
      if (response.statusCode == 201) {
        ...
        var d = jsonResponse.map((e) => OrderSummaryModel.fromJson(e)).toList();
